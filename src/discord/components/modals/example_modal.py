...
async def modal_listener(interaction: discord.Interaction):
    number1 = modal_fields[0].value 
    number2 = modal_fields[1].value 
...
modalSum = ModalBuilder(title="Sum the two numbers", items=modal_fields, modal_listener=modal_listener)